...
echo "################################################################"
echo "# STEP 1 of 4 — Fabric capacity (F2, Sweden Central)"
echo "################################################################"
./01_create_fabric_capacity.sh "${SUFFIX}"

echo "################################################################"
echo "# STEP 2 of 4 — Workspace + Lakehouse"
echo "################################################################"
./02_create_workspace_and_lakehouse.sh "${SUFFIX}"

echo "################################################################"
echo "# STEP 3 of 4 — Upload sample data"
echo "################################################################"
./03_upload_sample_data.sh

echo "################################################################"
echo "# STEP 4 of 4 — Warehouse + dbt credentials"
echo "################################################################"
./04_create_warehouse_and_get_dbt_creds.sh

echo ""
echo "################################################################"
echo "# ALL STEPS COMPLETE — see fabric_environment.env for every ID/"
echo "# connection string generated, and dbt_fabric_output/profiles.yml"
echo "# for the ready-to-use dbt configuration."
echo "################################################################"
